# Projeto DSList Back End
[![NPM](https://img.shields.io/npm/l/react)](https://github.com/AContesini/dlist/tree/main) 

# Sobre o Projeto
Este projeto foi desenvolvido durante o evento Intensivão Java Spring da DevSuperior, sob a orientação do Professor Nélio Alves.
Nele criamos uma API dedicada a fornecer dados e lógica de negócios para o Front End.

O projeto consiste em uma lista de jogos armazenada em um banco de dados. 
Por meio do back-end, é possível manipular essa lista realizando requisições, como, por exemplo, alterar a posição de um jogo.


# Modelo Web
![Modelo Web](https://github.com/AContesini/assets/blob/main/Sistmas_weB.png)
...
![Modelo de domínio DSList](https://github.com/AContesini/assets/blob/main/Modelo_de_Dominio_DS_list_Day.png)
...
https://github.com/AContesini/assets/blob/main/container-postreSQL/docker-compose.yml
